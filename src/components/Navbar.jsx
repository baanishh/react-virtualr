...
const [mobileDrawerOpen,setMobileDrawerOpener]=useState(false)
const toggleNavBar=()=>{
    setMobileDrawerOpener(!mobileDrawerOpen)
}
        ...
        <div className="container px-4 mx-auto relative text-sm">
            <div className='flex justify-between items-center'>
                ...
                <div className='hidden lg:flex justify-center space-x-12 items-center'>
                    <a className='border py-2 px-3 rounded-md' href="#">Sign In</a>
